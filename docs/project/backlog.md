...
### STORY-001: Research and Access METAR Data Sources
**Points**: 2 | **Created**: 2026-01-11
**Labels**: research
...
**Acceptance Criteria**:
- [ ] Iowa State University ASOS-AWOS-METAR API access documented (endpoints, authentication, rate limits)
- [ ] NOAA Aviation Weather Center historical data endpoints identified and tested
- [ ] API access confirmed for 2004-2024 date range
- [ ] Data schema documented: timestamp, wind speed, wind direction, gusts, visibility, temp, pressure, runway
- [ ] Sample data retrieved and validated (at least 1 month of observations)
